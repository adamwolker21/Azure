...
echo    9.  AU -  Australia
echo    10.  KR -  Korea South
read -p "Please select your Azure VM region (type number then press enter):" ans
case $ans in
    1  )  echo "FR"; echo francecentral > vm  ;;
    2  )  echo "DU"; echo germanywestcentral > vm  ;;
    3  )  echo "IT"; echo italynorth > vm  ;;
    4  )  echo "CH"; echo switzerlandnorth > vm  ;;
    5  )  echo "EU"; echo westeurope > vm  ;;
    6  )  echo "UK"; echo uksouth > vm  ;;
    7  )  echo "US"; echo eastus > vm  ;;
    8  )  echo "JP"; echo japaneast > vm  ;;
    9  )  echo "AU"; echo australiasoutheast > vm  ;;
    10  )  echo "KR"; echo koreasouth > vm  ;;
...
echo "Windows Server 2012 R Datacenter" > abc; echo MicrosoftWindowsServer:WindowsServer:2012-R-Datacenter:latest > win 
